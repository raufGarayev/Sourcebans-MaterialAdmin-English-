...
switch ($_GET['p'])
{
	...
	case "home":
		...
		break;
	case "search_bans":
		RewritePageTitle("Advanced ban search");
		$page = TEMPLATES_PATH . "/page.search_bans.php";
		break;
	case "search_comm":
		RewritePageTitle("Avanced blocks search");
		$page = TEMPLATES_PATH . "/page.search_comms.php";
		break;
	case "pay":
		RewritePageTitle("Activation");
		$page = TEMPLATES_PATH . "/page.vay4er.php";
		break;
	case "adminlist":
		RewritePageTitle("Adminlist");
		$page = TEMPLATES_PATH . "/page.adminlist.php";
		break;
  case "check":
    RewritePageTitle("Checking for ban");
