...
<title>{if $header_title != ""}{$header_title}{else}PG Bans{/if}</title>
												...
												<div class="input-group input-group-lg">
													...
													<div class="fg-line">
														<form method="get" action="index.php" >
															...
															<input type="text" class="form-control input-lg" placeholder="Search Bans" name="searchText" />
														</form>
													</div>
												</div>
												<div class="input-group input-group-lg">
													...
													<div class="fg-line">
														<form method="get" action="index.php">
															...
															<input type="text" class="form-control input-lg" placeholder="Search Mutes" name="searchText" />
														</form>
													</div>
												</div>
												<div class="lv-item">
													<div class="media">
														<div class="media-body">
															<div class="lv-title">Information</div>
															<small class="lv-small">The search is performed on all criteria.<br />Can use: SteamID, Player name...</small>
														</div>
													</div>
												</div>
											</div>
                                        ...
                                        <div class="row">
											<div class="col-xs-12">
												<div class="p-t-5 p-b-10 p-r-10 p-l-10 text-center">
													<button class="btn btn-primary btn-block btn-icon-text waves-effect" onclick="window.location.href='?p=search_bans'"><i class="zmdi zmdi-lock-outline"></i>Bans</button>
													<button class="btn btn-warning btn-block btn-icon-text waves-effect" onclick="window.location.href='?p=search_comm'"><i class="zmdi zmdi-mic-off"></i>Mutes</button>
												</div>
											</div>
										</div>
									</div>
                ...
                <div class="profile-menu">
                    <a href="#">
                        ...
                        <div class="profile-info">
                            {if $logged_in}Account: <mark>{$username}</mark>{else}Stranger{/if}
                    ...
                    <ul class="main-menu">
                        {if $logged_in}
							<li>
								<a href='index.php?p=account'><i class="zmdi zmdi-settings"></i> Profile</a>
							</li>
							<li>
								<a href='index.php?p=logout'><i class="zmdi zmdi-time-restore"></i> Logout</a>
							</li>
						{else}
							<li>
								<a href='index.php?p=login'><i class="zmdi zmdi-input-antenna"></i> Authorization</a>
							</li>
							{if $vay4er_act == "1"}
								<li>
									<a href='index.php?p=pay'><i class="zmdi zmdi-shopping-cart-plus"></i> Activate Promokey</a>
								</li>
							{/if}
                        {/if}
                    </ul>
