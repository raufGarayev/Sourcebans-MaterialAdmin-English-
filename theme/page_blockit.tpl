...
function set_counter(count)
{
	...
	if(srvcount==-{$total}- || count=='-1') {
		parent.document.getElementById('dialog-control').innerHTML = "<font color=\"green\" style=\"font-size: 12px;\"><b>Successfull search.</b></font>"+parent.document.getElementById('dialog-control').innerHTML;
...
<h3 style="font-size: 12px;">Looking for player in server...</h3>
<table border="0">
