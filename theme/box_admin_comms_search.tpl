	...
	<div class="col-sm-8">
		<div class="card">
				...
				<table width="100%" class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td class="p-b-5">
								<div class="fg-line">
									<input type="text" class="form-control" id="ban_reason" value="" onmouseup="$('reason_').checked = true" placeholder="Type block reason" />
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="p-b-5">
								<div class="p-t-5"><label for="ban_type" onclick="$('ban_type_').checked = true">Mute type</label></div>
							</td>
							<td class="p-b-5">
						...
						<tr>
							...
							<td class="p-b-5">
								<div class="p-t-5"><label for="server" onclick="$('where_banned').checked = true">Blocked on</label></div>
							</td>
							<td class="p-b-5">
			...
			<div class="card-body p-b-20 text-center">
				{sb_button text="Search" onclick="search_blocks();" icon="<i class='zmdi zmdi-search'></i>" class="bgm-green btn-icon-text" id="searchbtn" submit=false}
			</div>
		</div>
	</div>
	<div class="col-sm-2">
