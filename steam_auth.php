...
if (!$AuthResult)
  ...
  switch ($_SESSION['why']) {
    case 'user_auth': {
      ...
      \SessionManager::closeWrite();
      RedirectToSite($_SESSION['from'], 'You are successfully logged into the system. Now your SteamID will be automatically substituted where possible.', true);
      break;
    }
    ...
    case 'admin_auth': {
      ...
      if (\UserManager::forceLoginBySteam($SteamID, $ReasonMsg))
        RedirectToSite($_SESSION['from'], 'Administrator found, forwarding...');

      RedirectToSite($_SESSION['from'], "An error has occured: $ReasonMsg", true);
      break;
    }
  }
}