...
if(defined('DEVELOPER_MODE')) {
		...
		echo('<div class="card-header"><h2>Debug SourceBans</h2></div><div class="card-body card-padding">Debugging is active on SourceBans. For turning off, uncheck "Debugging" on SourceBans settings or fix line <pre>define(\'DEVELOPER_MODE\', true);</pre> on <i>config.php</i></div>');
		echo('<div class="card-header"><h2>Manager details of user</h2></div><div class="card-body card-padding"><pre>');
		PrintArray($userbank);
		echo('</pre></div><div class="card-header"><h2>Message details</h2></div><div class="card-body card-padding"><pre>');
		print_r($_POST);
		echo('</pre></div><div class="card-header"><h2>Connection details</h2></div><div class="card-body card-padding"><pre>');
	 	print_r($_SESSION);
	 	echo('</pre></div><div class="card-header"><h2>Cookie details</h2></div><div class="card-body card-padding"><pre>'); 
	 	print_r($_COOKIE);
