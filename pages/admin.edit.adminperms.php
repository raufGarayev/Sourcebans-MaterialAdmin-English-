...
{
	$log = new CSystemLog("w", "Block try", $userbank->GetProperty("user") . " tried to edit permissions ".$userbank->GetProperty('user', $_GET['id'])." , with no access.");
	echo '<div id="msg-red" >
	<i><img src="./images/warning.png" alt="Warning" /></i>
	<b>Error</b>
	<br />
	You ca not edit others permissions.
</div>';
	PageDie();
}
...
<div class="card-header">
   <h2>Permissions settings <small>Choose options</small></h2>
</div>
<div class="row">
...
<div class="card-body card-padding text-center">
   <button type="submit" onclick="ProcessEditAdminPermissions();" name="editadmingroup" class="btn bgm-green btn-icon-text waves-effect" onmouseover="ButtonOver(&quot;editadmingroup&quot;)" onmouseout="ButtonOver(&quot;editadmingroup&quot;)" id="editadmingroup" value="Update details">
   <i class="zmdi zmdi-check-all"></i>Update details
   </button>
