...
global $userbank, $theme; if(!defined("IN_SB")){echo "Permission error!";die();}if(isset($GLOBALS['IN_ADMIN']))define('CUR_AID', $userbank->GetAid());
...
function ProcessBan()
{
	...
	if(!$('nickname').value)
	{
		$('nick.msg').setHTML('Nick of player that you want to block');
	...
	if(!reason)
	{
		$('reason.msg').setHTML('Choose reason');
