...
if(isset($_POST['pay_v4']) && !empty($_POST['pay_v4']))
{
	...
	{ 
		echo '<div class="alert alert-danger" role="alert" id="msg-red"><h4>Ошибка!</h4><span class="p-l-10">Unknown error.</span></div>';
	
		require(TEMPLATES_PATH . "/footer.php");
		$log = new CSystemLog("w", "Hacking attempt", "Tried activation of promokey in use: " . $_SERVER['HTTP_HOST']);
		exit();
	}
	...
	{
		echo '<div class="alert alert-danger" role="alert" id="msg-red"><h4>Error!</h4><span class="p-l-10">Promokey is too short.</span></div>';
		require(TEMPLATES_PATH . "/footer.php");
		exit();
	}
	...
	if($qwr != "0" && $qwr == "1"){
		...
		if($user_group_web == "" || $user_group_web == "0"){
			$user_group_web = "Not defined/No Group";
		}
