...
if(!$userbank->HasAccess(ADMIN_OWNER))
  CreateRedBox("Access blocked!", "You do not have privilegies to view this page.");
else {
  if(isset($_POST['Link'])) { 
    if ($_POST['Link'] == "edit"){
      // insert.
      ...
      PushScriptToExecuteAfterLoadPage(sprintf("setTimeout(function() { %s; }, 1350);", generateMsgBoxJS("Success!", "Link successfully saved!", "green", "", true)));
