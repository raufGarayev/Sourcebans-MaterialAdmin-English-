...
<div id="add-group">
<h3> Edit groups</h3><br />
<input type="hidden" id="group_id" value=<?php echo $_GET['id']?> />
<table width="90%" style="border-collapse:collapse;" id="group.details" cellpadding="3">
  <tr>
    <td valign="top" width="35%"><div class="rowdesc"><?php echo HelpIcon("Group name", "Type group name that you want to create.");?>Group name </div></td>
    <td><div align="left">
...
<div class="rowdesc">Group override</div>
...
<i>Read about <b><a href="http://wiki.alliedmods.net/Adding_Groups_%28SourceMod%29" title="Adding Groups (SourceMod)" target="_blank">group overried</a></b> on AlliedModders Wiki!</i><br /><br />
Turn off overrides removing it.<br /><br />
...
<tr align="center">
    ...
    <td>
    <div align="center">
      <?php echo $ui->drawButton("Save", "ProcessEditGroup('".$_GET['type']."', $('groupname').value);", "ok", "editgroup", true);?>
