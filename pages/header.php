...
if($GLOBALS['config']['template.global'] == "1"){
	...
	$def_ch = '
				<li id="toggle-width" class="p-t-5">
					<div class="toggle-switch" data-trigger="hover" data-toggle="popover" data-placement="bottom" data-content="Activate fullscreen mod? Your browser will remember choice." title="" data-original-title="Management">
