...
{
    $log = new CSystemLog("w", "Hacking attempt", $userbank->GetProperty('user') . " tried to upload demo with no permission.");
...
if(isset($_POST['upload']))
{
	if (CheckExt($_FILES['demo_file']['name'], ["dem", "zip", "rar", "7z", "bz2", "gz"])) {
        ...
        $log = new CSystemLog("m", "Demo uploaded", "New demo successfully uploaded: ".htmlspecialchars($_FILES['demo_file']['name']));
	} else
