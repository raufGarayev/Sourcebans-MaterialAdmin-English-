...
//$submenu = array( array( "title" => 'Forgot password?', "url" => 'index.php?p=lostpassword' ) );
//SubMenu( $submenu );
if(isset($_GET['m']) && $_GET['m'] == "no_access")
	echo "<script>setTimeout(\"ShowBox('Error - No access', 'You do not have access to this page.<br />Login to account.', 'red', '', false);\", 1200);</script>";
